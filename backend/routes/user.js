...
//check passord is mathed or not
...
res.cookie("PodZenUserToken",token,{
    httpOnly: true,
...
router.post("/logout", async (req,res) => {
    res.clearCookie("PodZenUserToken", {
        httpOnly:true,
...
router.get("/check-cookie", async (req,res) => {
    const token = req.cookies.PodZenUserToken;
    if (token){
